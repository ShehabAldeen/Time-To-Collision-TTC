...
void detKeypointsShiTomasi(vector<cv::KeyPoint> &keypoints, cv::Mat &img, bool bVis)
{
    ...
    //keypoints_num.push_back(keypoints.size()); // for logging purposes
}
...
{
    cv::Ptr<cv::FeatureDetector> detector; // to change based on the detector algorithm
    ...
    {
        cerr << "wrong modern detector type" <<endl;
    }
